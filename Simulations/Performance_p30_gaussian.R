...
saveRDS(HorseRuleMat,'output/HorseRuleMat_p30.Rda')
saveRDS(RuleSHAPMat,'output/RuleSHAPMat_p30.Rda')
saveRDS(shapleys_dfs,'output/shapleys_dfs_p30.Rda')
saveRDS(hr_shapleys,'output/hr_shapleys_p30.Rda')
...
df=data.frame(coef=c(readRDS('RuleFitMat_p30.Rda')[1:p_show,],
                     readRDS('RuleSHAPMat_p30.Rda')[1:p_show,],
                     readRDS('HorseRule1Mat_p30.Rda')[1:p_show,],
                     readRDS('LinRegMat_p30.Rda')[1:p_show,],
                     readRDS('LassoMat_p30.Rda')[1:p_show,]),
...
hr_dfs=readRDS('output/hr_shapleys_p30.Rda')
models=c('OLS','LASSO','RuleSHAP','RuleFit','HorseRule','BART','RF')
